				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 2410 14th Ave?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 2410 14th Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										<a href="images/comp1a.jpg" class="image full fancybox"><img src="images/comp1a.jpg" alt="" /></a>
										<header>
										<h3><strong>2547 14th Ave</strong></h3>
										<ul>
											<li>2 Bed - 1 Bath</li>
											<li>1,260 Sq Ft -  2,485 Lot</li>
											<li>List: 1/2/14 - Sold: 2/23/14</li>
											<li>List: $299,000 - SOLD $288,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										<a href="images/comp2a.jpg" class="image full fancybox"><img src="images/comp2a.jpg" alt="" /></a>
										<header>
										<h3><strong>1424 E 20th St</strong></h3>
										<ul>
											<li>2 Bed - 1 Bath</li>
											<li>1,136 Sq Ft - 2,400 Lot</li>
											<li>List: 10/1/13 - Sold: 11/7/13</li>
											<li>List: $279,000 - SOLD $279,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										<a href="images/comp3a.jpg" class="image full fancybox"><img src="images/comp3a.jpg" alt="" /></a>
										<header>
										<h3><strong>2553 Wallace St</strong></h3>
										<ul>
											<li>2 Bed - 1 Bath</li>
											<li>660 Sq Ft - 2,937 Lot</li>
											<li>List: 10/15/13 - Sold: 12/11/13</li>
											<li>List: $239,900 - SOLD $235,000</li>
										</ul>
									</article>
								</div>
							</div>
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=54aa9bca-30e8-420f-8cb0-eaf974313eb8&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.jpg" /></a>
						</div>
					</section>
